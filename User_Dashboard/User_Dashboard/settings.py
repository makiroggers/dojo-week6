...
FILES_DIR = os.path.abspath(os.path.join(BASE_DIR, '../User_Dashboard/templates'))
...
SECRET_KEY = 'oi(yz2if4%b)0mh4k8)ddi3#y=7lzpn+qu6e$=#y4c6e+51nlz'
...
TEMPLATES = [
    {
        ...
        'DIRS': 
                [os.path.join(os.path.dirname(__file__), '../User_Dashboard/'),
                 os.path.join(os.path.dirname(__file__), '../apps/users/templates/users/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
