...
SECRET_KEY = '-z$gi5@)gj=(rhdbwz2n^8icr!jm#m(ajrrpycpx^#j-@7kq**'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(__file__), '../Local_Library/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIR = [
    ...
    os.path.join(BASE_DIR, "Local_Library/static/")
]
